    ...
    <div className="min-h-screen bg-gray-950 flex items-center justify-center px-4">
      ...
      <div className="w-full max-w-sm">
        ...
        <div className="bg-gray-900 border border-gray-800 rounded-2xl p-6">
          <h2 className="text-lg font-bold text-white mb-5">{t('register.heading')}</h2>
          {error && (
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            <div>
              ...
              <input name="username" required autoComplete="username" maxLength={32} placeholder={t('register.usernamePlaceholder')}
          ...
          <p className="text-center text-gray-500 text-sm mt-5">
            {t('register.alreadyHaveAccount')}{' '}<Link to="/login" className="text-purple-400 hover:text-purple-300 font-medium">{t('register.signIn')}</Link>
          </p>
        </div>
      </div>
    </div>
